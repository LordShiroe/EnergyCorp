 ...
 * @author CarlosArturo
 */
public class su010_gu111Model {

    private static final Logger LOG = Logger.getLogger(su010_gu111Model.class.getName());

    /**
     * Servicio para borrar un Usuario de la base de datos
     *
     * @param username Nombre de Usuario
     * @return True si lo borra, false de lo contrario.
     */
...
//            transaction.rollback();
     ...
     *
     * @param user Usuario
     * @return true si lo edita, false de lo contrario.
     */
...
//            transaction.rollback();
     ...
     * @return true si lo crea, false de lo contrario.
     */
